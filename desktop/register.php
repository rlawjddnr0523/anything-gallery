...
<div class="grid1">
    <form method="post" action="register1.php">
        <div class="form1">
            <ul>
                <li>
                    <textarea class="textarea1-contents" readonly>제1조(목적) 이 약관은 회사가 온라인으로 제공하는 디지털콘텐츠(이하 "콘텐츠"라고 한다) 및 제반서비스의 이용과 관련하여 회사와 이용자와의 권리, 의무 및 책임사항 등을 규정함을 목적으로 합니다.
                ...
                <li>
                    <label>약관에 동의합니다 (필수) </label><input type="checkbox" required>
                </li>
            </ul>
        </div>
    </form>
